            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-sm">Today&apos;s Visitors</p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                        <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">2.3m</p>
            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                ...
                <div className="space-y-3">
                    {analytics?.visitors.recent.slice(0, 5).map((visitor: Visitor, i: number) => (
                        <div
                            key={i}
                            className="flex justify-between items-center p-3 bg-gray-100 dark:bg-gray-700/30 rounded-lg"
                        >
                            <div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                <h3 className="text-lg font-semibold mb-4 flex items-center gap-2 text-gray-900 dark:text-white">
                    <Map className="text-green-600 dark:text-green-400" size={20} />
                    Top Countries
                </h3>
                <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                    <div
                                        ...
                                        style={{
                                            width: `${(country.count / (analytics?.visitors.topCountries[0]?.count || 1)) * 100
                                                }%`,
                                        }}
                                    />
                                </div>
                                <span className="text-gray-600 dark:text-gray-400 text-sm w-6">{country.count}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-green-600 dark:text-green-400 font-medium">1.2s</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-gray-700 dark:text-gray-300">Bounce Rate</span>
                        <span className="text-yellow-600 dark:text-yellow-400 font-medium">23%</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-gray-700 dark:text-gray-300">Pages/Session</span>
                        <span className="text-cyan-600 dark:text-cyan-400 font-medium">3.4</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-gray-700 dark:text-gray-300">Conversion Rate</span>
                        <span className="text-purple-600 dark:text-purple-400 font-medium">8.7%</span>
                    </div>
                </div>
            </div>
        </div>
